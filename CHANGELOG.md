...
- `autospec implement`, `autospec status`, and related workflow commands now fall back to the current branch when persisted active-feature state points at a deleted spec directory
