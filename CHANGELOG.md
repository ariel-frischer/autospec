...
- Autospec now consumes the published `github.com/ariel-frischer/jcode-go` v0.1.2 module, including the safe-run ownership API, without requiring a sibling jcode checkout
