...
- Autospec now consumes the experimental [`github.com/ariel-frischer/jcode-go`](https://github.com/ariel-frischer/jcode-go) v0.1.6 SDK with race-free owned turns, without requiring a sibling jcode checkout
