...
Could also add ability to pass existing artifact to Claude for modification rather than regeneration:
- `autospec plan --modify` - refine existing plan.yaml
- `autospec tasks --modify` - refine existing tasks.yaml

This would require changes to the slash commands to accept existing content as input.
