...
var KnownKeys = map[string]ConfigKeySchema{
	...
	"opencode.model": {
		Path:        "opencode.model",
		Type:        TypeString,
		Description: "Default OpenCode model for workflow stages",
		Default:     "",
	},
	"opencode.models.specify": {
		Path:        "opencode.models.specify",
		Type:        TypeString,
		Description: "OpenCode model for the specify stage",
		Default:     "",
	},
	"opencode.models.plan": {
		Path:        "opencode.models.plan",
		Type:        TypeString,
		Description: "OpenCode model for the plan stage",
		Default:     "",
	},
	"opencode.models.tasks": {
		Path:        "opencode.models.tasks",
		Type:        TypeString,
		Description: "OpenCode model for the tasks stage",
		Default:     "",
	},
	"opencode.models.implement": {
		Path:        "opencode.models.implement",
		Type:        TypeString,
		Description: "OpenCode model for the implement stage",
		Default:     "",
	},
	"opencode.models.constitution": {
		Path:        "opencode.models.constitution",
		Type:        TypeString,
		Description: "OpenCode model for the constitution stage",
		Default:     "",
	},
	"opencode.models.clarify": {
		Path:        "opencode.models.clarify",
		Type:        TypeString,
		Description: "OpenCode model for the clarify stage",
		Default:     "",
	},
	"opencode.models.checklist": {
		Path:        "opencode.models.checklist",
		Type:        TypeString,
		Description: "OpenCode model for the checklist stage",
		Default:     "",
	},
	"opencode.models.analyze": {
		Path:        "opencode.models.analyze",
		Type:        TypeString,
		Description: "OpenCode model for the analyze stage",
		Default:     "",
	},
	"max_retries": {
		Path:        "max_retries",
